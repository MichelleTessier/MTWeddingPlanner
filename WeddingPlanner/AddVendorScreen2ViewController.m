//
//  AddVendorScreen2ViewController.m
//  WeddingPlanner
//
...
@interface AddVendorScreen2ViewController ()

@end

@implementation AddVendorScreen2ViewController
...
-(void)nextScreenBarButtonTapped{
    [self.navigationController pushViewController:[AddVendorScreen3ViewController new] animated:YES];
}
